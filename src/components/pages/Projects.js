...
<div className="card mb-3 bg-dark text-light">
        <div className="row g-0">
          <div className="col-md-4">
            <img src={StoryFactory} class="img-fluid rounded-start border border-white" alt="Perfect Cup Homepage"/>
          </div>
          <div className="col-md-8">
            <div className="card-body">
              <h5 className="card-title">Story Factory</h5>
              <p className="card-text">Story Factory is a game that allows players to practice their creative writing abilities by contributing to stories generated by their fellow players. </p>
              <a href="https://quiet-sierra-37143.herokuapp.com" class="btn btn-primary">Visit</a>
              <a href="https://github.com/MChambersIV/Story-Factory" class="btn btn-success">GitHub</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row g-0">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">Perfect Cup is another project I completed as part of a small team. It allows a user to create an account and then create their ideal coffee from a list of ingredients. Then they can learn about about their coffee once it's created.</p>
